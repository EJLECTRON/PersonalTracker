...
# Form implementation generated from reading ui file 'data_analysis_interface.ui'
#
...
class Ui_DataAnalysisWidget(object):
    def setupUi(self, DataAnalysisWidget):
        DataAnalysisWidget.setObjectName("DataAnalysisWidget")
        DataAnalysisWidget.resize(1000, 670)
        DataAnalysisWidget.setStyleSheet("*\n"
"{\n"
...
"}\n"
"")
        self.verticalLayout = QtWidgets.QVBoxLayout(DataAnalysisWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.centralwidget = QtWidgets.QWidget(DataAnalysisWidget)
        ...
        self.plotLabel = QtWidgets.QLabel(self.mainTopWidget)
        self.plotLabel.setObjectName("plotLabel")
        self.verticalLayout_7.addWidget(self.plotLabel, 0, QtCore.Qt.AlignHCenter)
        self.textBrowser = QtWidgets.QTextBrowser(self.mainTopWidget)
        ...
        self.retranslateUi(DataAnalysisWidget)
        QtCore.QMetaObject.connectSlotsByName(DataAnalysisWidget)

    def retranslateUi(self, DataAnalysisWidget):
        _translate = QtCore.QCoreApplication.translate
        DataAnalysisWidget.setWindowTitle(_translate("DataAnalysisWidget", "Form"))
        self.menuBtn.setToolTip(_translate("DataAnalysisWidget", "Menu"))
        self.homeBtn.setToolTip(_translate("DataAnalysisWidget", "Home"))
        self.homeBtn.setText(_translate("DataAnalysisWidget", "Home"))
        self.archiveBtn.setToolTip(_translate("DataAnalysisWidget", "Archive"))
        self.archiveBtn.setText(_translate("DataAnalysisWidget", "Archive data"))
        self.dataAnalysisBtn.setToolTip(_translate("DataAnalysisWidget", "Data Analysis"))
        self.dataAnalysisBtn.setText(_translate("DataAnalysisWidget", "Data Analysis"))
        self.pushButton.setText(_translate("DataAnalysisWidget", "Helpful articles"))
        self.settingsBtn.setToolTip(_translate("DataAnalysisWidget", "Settings"))
        self.settingsBtn.setText(_translate("DataAnalysisWidget", "Settings"))
        self.reportBtn.setToolTip(_translate("DataAnalysisWidget", "Report"))
        self.reportBtn.setText(_translate("DataAnalysisWidget", "Report"))
        self.plotLabel.setText(_translate("DataAnalysisWidget", "There\'ll be plot"))
...
if __name__ == "__main__":
    ...
    DataAnalysisWidget = QtWidgets.QWidget()
    ui = Ui_DataAnalysisWidget()
    ui.setupUi(DataAnalysisWidget)
    DataAnalysisWidget.show()
    sys.exit(app.exec_())
